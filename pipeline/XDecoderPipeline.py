...
from .misc import hook_metadata, hook_switcher, hook_opt
...
class XDecoderPipeline:
    ...
    def forward_step(
        ...
        return loss_info, sample_size_info
    ...
    def evaluate_model(
        ...
        for dataset_label in dataset_names:
            ...
            eval_batch_gen = self.get_dataloaders(dataset_label, is_evaluation=True)
